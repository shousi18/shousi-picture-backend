...
public class GetImageFirstUrlApi {
            ...
            for (Element script : scriptElements) {
                ...
                if (scriptContent.contains("\"firstUrl\"")) {
                    ...
                    if (matcher.find()) {
                        ...
                        // 添加 page 参数，可以搜到不同的结果
                        firstUrl += "&page=" + RandomUtil.randomInt(0, 10) + "&";
                        return firstUrl;
                    }
                }
            }
    ...
    public static void main(String[] args) {
        // 请求目标 URL
        String url = "https://graph.baidu.com/s?card_key=&entrance=GENERAL&extUiData[isLogoShow]=1&f=all&isLogoShow=1&session_id=9578222756948985346&sign=121b39aa48d944d3c6cd501743736775&tpl_from=pc";
