...
public class SpaceUserServiceImpl extends ServiceImpl<SpaceUserMapper, SpaceUser>
    ...
    public void validSpaceUser(SpaceUser spaceUser, boolean add) {
        ...
        Long createUserId = spaceUser.getCreateUserId();
        if (add) {
            ...
            ThrowUtils.throwIf(createUserId == null, ErrorCode.PARAMS_ERROR, "创建用户不存在");
        }
        // 校验空间角色
        ...
        Integer inviteStatus = spaceUser.getInviteStatus();
        SpaceUserInviteStatusEnum userInviteStatusEnum = SpaceUserInviteStatusEnum.getEnumByValue(inviteStatus);
        if (inviteStatus != null && userInviteStatusEnum == null) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR, "邀请状态不存在");
        }
    }
    ...
    public QueryWrapper<SpaceUser> getQueryWrapper(SpaceUserQueryRequest spaceUserQueryRequest) {
        ...
        queryWrapper.eq(ObjUtil.isNotEmpty(inviteStatus), "inviteStatus", inviteStatus);
